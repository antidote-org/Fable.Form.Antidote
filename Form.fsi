...
module Form =
    ...
    /// <summary>
    /// Disable the form if the condition is true.
    /// </summary>
    /// <param name="condition">Control if the form should be disabled or not</param>
    /// <param name="form">The form to disable</param>
    /// <returns>A new form which has been marked as disabled</returns>
    val disableIf:
        condition: bool ->
    ...
    /// <para>
    /// See <see cref="T:Fable.Form.Base.FieldConfig"/> for more information
    /// </para>
    /// </param>
    ...
    /// <summary>
    /// Create a form that contains a single switch field
    /// </summary>
    /// <param name="config">A record used to configure the field behaviour.
    /// <para>
    /// See <see cref="T:Fable.Form.Base.FieldConfig"/> for more information
    /// </para>
    /// </param>
    /// <returns>Returns a form representing a switch field</returns>
    val switchField :
    ...
    /// <summary>
    /// Create a form that contains a single flat checkbox field
    /// </summary>
    /// <param name="config">A record used to configure the field behaviour.
    /// <para>
    /// See <see cref="T:Fable.Form.Base.FieldConfig"/> for more information
    ...
    /// <summary>
    /// Create a form that contains a single react component field
    /// </summary>
    /// <param name="config">A record used to configure the field behaviour.
    /// <para>
    /// See <see cref="T:Fable.Form.Base.FieldConfig"/> for more information
    /// </para>
    /// </param>
    /// <returns>Returns a form representing the provided react component field</returns>
    val reactComponentField :
        config : Base.FieldConfig<ReactComponentField.Attributes,string,'Values, 'Output> ->
        Form<'Values,'Output, 'Attributes>

    /// <summary>
    /// Create a form that contains a text autocomplete field
    /// </summary>
    /// <param name="config">A record used to configure the field behaviour.
    /// <para>
    /// See <see cref="T:Fable.Form.Base.FieldConfig"/> for more information
    /// </para>
    /// </param>
    /// <returns>Returns a form representing a text autocompletecomponent field</returns>
    val textAutocompleteField :
        config : Base.FieldConfig<TextAutocompleteField.Attributes,string,'Values, 'Output> ->
        Form<'Values,'Output, 'Attributes>

    /// <summary>
    /// Create a form that contains a single tag list field
    /// </summary>
    /// <param name="config">A record used to configure the field behaviour.
    /// <para>
    /// See <see cref="T:Fable.Form.Base.FieldConfig"/> for more information
    ...
    /// <param name="config">A record used to configure the field behaviour.
    /// <para>
    /// See <see cref="T:Fable.Form.Base.FormList.Config"/> for more information
    /// </para>
    /// </param>
    ...
    /// <para>
    /// See <see cref="T:Fable.Form.Simple.Form.MapValuesConfig`2"/> for more information
    /// </para>
    /// </param>
        ...
        type SelectFieldConfig<'Msg, 'Attributes> =
            {
                ...
                Error: Error.Error option
                ShowError: bool
                Attributes: Field.SelectField.Attributes<'Attributes>
            }
